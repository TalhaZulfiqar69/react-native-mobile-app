...
export const ContactDetails = () => {
  ...
  const contact: Person | undefined = contacts.find(
    (contact) => contact.id === route.params.contactId
  );
        ...
        >
          {({ pressed }) => (
            <Text style={styles.text}>
              {pressed ? "Hold For Confirmation" : "Delete Contract"}
            </Text>
          )}
        </Pressable>
      </View>
