...
export const CreateContact = () => {
  ...
  const changeValue = (propertyName: string, newValue: string) =>
  ...
  const onCreateContact = () => {
    const newContact = createContact(
      ...
      state.lastName,
      state.email,
      Number.parseInt(state.roomNumber)
    );
    onCreate(newContact);
    ...
    <View style={styles.container}>
      <View style={styles.row}>
        ...
        <TextInput
          ...
          onChangeText={(text: string) => changeValue("firstName", text)}
          style={styles.input}
        ></TextInput>
      </View>
      <View style={styles.row}>
        ...
        <TextInput
          ...
          onChangeText={(text: string) => changeValue("lastName", text)}
          style={styles.input}
        ></TextInput>
      </View>
      <View style={styles.row}>
        ...
        <TextInput
          value={state.email}
          onChangeText={(text: string) => changeValue("email", text)}
          style={styles.input}
        ></TextInput>
      </View>
      <View style={styles.row}>
        ...
        <TextInput
          ...
          onChangeText={(text: string) => changeValue("roomNumber", text)}
          style={styles.input}
        ></TextInput>
      </View>
      <View style={styles.row}>
